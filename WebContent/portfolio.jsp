				...
				<div class="col-lg-12">
					<div class="filters project-filter">
						<ul>
							...
							<%
								SimpleDateFormat format2 = new SimpleDateFormat("yyyy년 MM월dd일");/* dd일 */
							...
							<%String[] weeklist = {"Mon", "Tue", "Wen", "Thu", "Fri", "Sat", "Sun"}; %>
							<%for (int i = 0; i < weeklist.length; i++) {
							%>
							
							<li data-filter=".<%=weeklist[i]%>"><%=weeklist[i]%></li>
							<%} %>
						</ul>
					</div>
					<div class="projects_inner row" id="lightgallery">
						...
						<%
							...
							int w = 0;
							while (true) {
								URL url = new URL("https://firebasestorage.googleapis.com/v0/b/test-fce56.appspot.com/o/captureImages%2F"
								+ weeklist[w] + "_" + month + "_" + sysdate + "_" + i + ".png?alt=media");
							...
							for (j = i - 1; j > 0; j--) {
						%>
						<div class="col-lg-4 col-sm-6 all <%=weeklist[w]%>"
							data-src="https://firebasestorage.googleapis.com/v0/b/test-fce56.appspot.com/o/captureImages%2F<%=weeklist[w]%>_<%=j%>.png?alt=media">
							<div class="projects_item">
								<img class="img-fluid w-100"
									src="https://firebasestorage.googleapis.com/v0/b/test-fce56.appspot.com/o/captureImages%2F<%=weeklist[w]%>_<%=j%>.png?alt=media">
								<div class="icon">
							...
							<div class="projects_text">
								<h4>
									<a href="portfolio-details.html"><%=korDayOfWeek%></a>
								</h4>
								<p><%=format_time2%></p>
							</div>
						</div>
